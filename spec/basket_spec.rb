...
describe Basket do
  ...
  context "PureSolo scenarios" do
    ...
    it "should create correct shopping basket for 3x orange and 1x milk" do
      @basket.add(@orange)
      @basket.add(@orange)
      @basket.add(@orange)
      @basket.add(@milk)
      @basket.display_basket
      @basket.line_items.size.should == 2
      @basket.line_items.first.quantity.should == 3
      @basket.line_items.last.quantity.should == 1
      @basket.discount_in_pence.should == 29
    end

    it "should create correct shopping basket for 1x orange and 1x bread" do
      @basket.add(@orange)
      @basket.add(@bread)
      @basket.display_basket
      @basket.line_items.size.should == 2
    ...
    it "should create correct shopping basket for 2x shower gels and 3x orange" do
      @basket.add(@gel)
      @basket.add(@gel)
      @basket.add(@orange)
      @basket.add(@orange)
      ...
      @basket.line_items.size.should == 2
      @basket.line_items.first.quantity.should == 2
      @basket.line_items.last.quantity.should == 3
      @basket.discount_in_pence.should == (29 + ((119* 2) - 200))
    end
  end
end
